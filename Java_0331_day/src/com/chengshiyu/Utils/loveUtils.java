...
public class loveUtils {
    ...
    /*工具方法一，创建list集合*/
    public static ArrayList<User> getArrayUser(){
        ArrayList<User> list = new ArrayList<>();
        Random random = new Random();

        for (int i = 1; i < 10; i++){
            int anInt = random.nextInt(10000);
            list.add(new User(getRandomName(),anInt));
        }
    ...
    /*工具方法二，创建set集合*/
    public static HashSet<User> getSetUser(){
        ...
        for (int i = 1; i <= 10;i++){
            ...
            objects.add(new User(getRandomName(),i1));
        }
        return objects;
    }
